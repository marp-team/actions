...
function upload(opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, assert_1.default)(files.length, 'Files for uploading are not found.');
        ...
        for (const f of files) {
            (0, core_1.debug)(`Uploading ${f}...`);
            const { size } = yield stat(f);
            const buf = yield readFile(f);
            yield octokit.rest.repos.uploadReleaseAsset({
                ...
                data: buf, // https://github.com/octokit/types.ts/issues/73
            });
        }
    });
}
